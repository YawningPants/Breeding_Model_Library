...
在这里，我们使用视觉大模型在害虫检测任务上进行微调，对四类害虫进行了定位和识别。

<img src="assets/image-20230506105757129.png" alt="image-20230506105757129" style="zoom:50%;" />
...
在我们的害虫检测数据集上微调过的swin-transformer权重也可以在百度云下载。   
链接：https://pan.baidu.com/s/1d-7JsdgSF2u72BTqFrvmrg?pwd=g43t 
提取码：g43t

训练所用的VOC格式的害虫检测迷你数据集也可以在百度云下载。   
...
_defaults = {
    ...
    #--------------------------------------------------------------------------#
    "model_path"        : 'swin_tiny_patch4_window7_224_pest_detection.pth',
...
https://github.com/bubbliiiing/yolov5-pytorch/tree/main  
